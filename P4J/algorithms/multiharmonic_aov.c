...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            ".",
            "/home/ignacio/anaconda3/envs/p4j_develop/lib/python3.6/site-packages/numpy/core/include"
        ],
        "libraries": [
            "m"
        ],
 ...
 */
    __pyx_t_7 = __pyx_v_i;
    (__pyx_v_self->mag[__pyx_v_i]) = (*((__pyx_t_3P4J_10algorithms_17multiharmonic_aov_DTYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_3P4J_10algorithms_17multiharmonic_aov_DTYPE_t *) __pyx_v_mag.data) + __pyx_t_7)) )));
 ...
 */
    __pyx_t_8 = __pyx_v_i;
    (__pyx_v_self->err[__pyx_v_i]) = (*((__pyx_t_3P4J_10algorithms_17multiharmonic_aov_DTYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_3P4J_10algorithms_17multiharmonic_aov_DTYPE_t *) __pyx_v_err.data) + __pyx_t_8)) )));
  }
 ...
 */
      ...
      /* "P4J/algorithms/multiharmonic_aov.pyx":120
 *                 sr = alr*self.znr[i] - ali*self.zni[i]
 *                 si = alr*self.zni[i] + ali*self.znr[i]
 *                 tmp = self.pr[i]*self.zr[i] - self.pi[i]*self.zi[i] - sr*self.pr[i] - si*self.pi[i]             # <<<<<<<<<<<<<<
 *                 self.pi[i] = self.pr[i]*self.zi[i] + self.pi[i]*self.zr[i] + sr*self.pi[i] - si*self.pr[i]
 ...
 */
      ...
      /* "P4J/algorithms/multiharmonic_aov.pyx":123
 *                 self.pi[i] = self.pr[i]*self.zi[i] + self.pi[i]*self.zr[i] + sr*self.pi[i] - si*self.pr[i]
 *                 self.pr[i] = tmp
 *                 tmp = self.znr[i]*self.zr[i] - self.zni[i]*self.zi[i]             # <<<<<<<<<<<<<<
 *                 self.zni[i] = self.zni[i]*self.zr[i] + self.znr[i]*self.zi[i]
...
static void __pyx_pf_3P4J_10algorithms_17multiharmonic_aov_5MHAOV_4__dealloc__(struct __pyx_obj_3P4J_10algorithms_17multiharmonic_aov_MHAOV *__pyx_v_self) {
  ...
  /* "P4J/algorithms/multiharmonic_aov.pyx":132
 * 
 *     def __dealloc__(self):
 *         PyMem_Free(self.mjd)             # <<<<<<<<<<<<<<
 *         PyMem_Free(self.mag)
 ...
 */
  ...
  /* "P4J/algorithms/multiharmonic_aov.pyx":136
 *         PyMem_Free(self.err)
 *         PyMem_Free(self.zr)
 *         PyMem_Free(self.zi)             # <<<<<<<<<<<<<<
 *         PyMem_Free(self.znr)
 ...
 */
  ...
  /* "P4J/algorithms/multiharmonic_aov.pyx":139
 *         PyMem_Free(self.znr)
 *         PyMem_Free(self.zni)
 *         PyMem_Free(self.pr)             # <<<<<<<<<<<<<<
 *         PyMem_Free(self.pi)
 ...
 */
  ...
  /* "P4J/algorithms/multiharmonic_aov.pyx":142
 *         PyMem_Free(self.pi)
 *         PyMem_Free(self.cfr)
 *         PyMem_Free(self.cfi)             # <<<<<<<<<<<<<<
 * 
