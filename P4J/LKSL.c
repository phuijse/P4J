...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_3P4J_4LKSL_DTYPE_t(PyObject *);
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initLKSL(void); /*proto*/
PyMODINIT_FUNC initLKSL(void)
#else
PyMODINIT_FUNC PyInit_LKSL(void); /*proto*/
PyMODINIT_FUNC PyInit_LKSL(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_LKSL(void)", 0);
...
/* ObjectToMemviewSlice */
        static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_3P4J_4LKSL_DTYPE_t(PyObject *obj) {
