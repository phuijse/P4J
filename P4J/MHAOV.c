...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_3P4J_5MHAOV_DTYPE_t(PyObject *);
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("P4J.MHAOV.allocate_and_verify", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  3:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Nharmonics);
 ...
 *             for i in range(self.N):
 */
  __pyx_t_3 = ((2 * __pyx_v_self->Nharmonics) + 1);
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initMHAOV(void); /*proto*/
PyMODINIT_FUNC initMHAOV(void)
#else
PyMODINIT_FUNC PyInit_MHAOV(void); /*proto*/
PyMODINIT_FUNC PyInit_MHAOV(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_MHAOV(void)", 0);
...
/* ObjectToMemviewSlice */
        static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_3P4J_5MHAOV_DTYPE_t(PyObject *obj) {
