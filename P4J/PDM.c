...
static int __pyx_pw_3P4J_3PDM_3PDM_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mag)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 3, 4, 1); __PYX_ERR(0, 40, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_err)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 0, 3, 4, 2); __PYX_ERR(0, 40, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (kw_args > 0) {
    ...
    __pyx_v_mjd = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_3P4J_3PDM_DTYPE_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mjd.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_mag = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_3P4J_3PDM_DTYPE_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mag.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_err = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_3P4J_3PDM_DTYPE_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_err.memview)) __PYX_ERR(0, 40, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_Nbins = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_Nbins == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 40, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("__init__", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 40, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
    __pyx_t_5 = __pyx_v_i;
    (__pyx_v_self->err2[__pyx_v_i]) = powf((*((__pyx_t_3P4J_3PDM_DTYPE_t *) ( /* dim=0 */ ((char *) (((__pyx_t_3P4J_3PDM_DTYPE_t *) __pyx_v_err.data) + __pyx_t_5)) ))), 2.0);
  }
...
static PyObject *__pyx_pw_3P4J_3PDM_3PDM_3eval_frequency(PyObject *__pyx_v_self, PyObject *__pyx_arg_freq) {
  ...
  assert(__pyx_arg_freq); {
    __pyx_v_freq = __pyx_PyFloat_AsFloat(__pyx_arg_freq); if (unlikely((__pyx_v_freq == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
 ...
 */
  ...
  __pyx_t_8 = PyFloat_FromDouble(((__pyx_v_PDM_num * __pyx_v_self->normalizer) / __pyx_v_PDM_den)); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 93, __pyx_L1_error)
